...
const createScene = () => {
    ...
    groundMat.diffuseTexture = new BABYLON.Texture("/e7a29eb7-3244-4caf-bd4a-dc704cb44da8/DiscordStuffs/textures/groundTexture.jpg", scene);
    ...
    BABYLON.SceneLoader.ImportMesh("", "/e7a29eb7-3244-4caf-bd4a-dc704cb44da8/DiscordStuffs/glbs/", "4bb3a8d88abff1e7bb7ce34b87c64494.glb", scene,
    ...
    BABYLON.SceneLoader.ImportMesh("", "/e7a29eb7-3244-4caf-bd4a-dc704cb44da8/DiscordStuffs/glbs/", "ae1db540a529ec318de726647102b250.glb", scene,
        (meshes) => {
            ...
            const jamesTexture = new BABYLON.Texture("/e7a29eb7-3244-4caf-bd4a-dc704cb44da8/DiscordStuffs/textures/James-texture.webp", scene);
            meshes.forEach(mesh => {
                if (mesh.material) {
